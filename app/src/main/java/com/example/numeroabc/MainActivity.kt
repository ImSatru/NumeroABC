package com.example.numeroabc

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import com.example.numeroabc.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enlace.btnCalcular.setOnClickListener {
            calcularResultado(enlace)
        }
    }

    private fun calcularResultado(enlace: ActivityMainBinding) {
